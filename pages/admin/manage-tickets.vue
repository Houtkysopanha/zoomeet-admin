  ...
  <div class="p-6 bg-[#F8F8FF]">
    <div class="mb-6">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl text-gray-500 mb-2">Event / Manage Booking /<span class="text-[#7A49C9] font-bold"> Manage Ticketes</span></h1>
        </div>
    ...
    >
      ...
      <!-- Booking Name -->
      <Column field="ticketId" header="Ticket ID" sortable class="text-[14px] border-b border-gray-300">
      ...
      <!-- Phone Number -->
      <Column field="TicketsHolder" header="Tickets Holder" sortable class="text-[14px] border-b border-gray-300">
        <template #body="slotProps">
      ...
      <!-- Email -->
      <Column field="phoneNumber" header="Phone Number" class="text-[14px] border-b  border-gray-300" />

      <!-- Purchase Date -->
      <Column field="Email" header="Assign by" sortable class="text-[14px] border-b border-gray-300">
        <template #body="slotProps">
      ...
      <!-- No. Ticket -->
      <Column field="Assign Date" header="No. Ticket" class="text-[14px] text-center border-b border-gray-300">
        <template #body="slotProps">
      ...
      <!-- Payment -->
      <Column field="TypeTicket" header="Type Ticket" class="text-[14px] text-start border-b border-gray-300">
        <template #body="slotProps">
      ...
      <!-- Amount (USD) -->
      <Column field="Price" header="Price" class="text-[14px] text-center border-b border-gray-300">
        <template #body="slotProps">
      ...
      <!-- Status -->
      <Column field="Check-in" header="Check-in" class="text-[14px] border-b border-gray-300">
        <template #body="slotProps">
