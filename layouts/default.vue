<template>
  <div class="relative min-h-screen  px-4 py-6 lg:py-10 animated-gradient" style="background-color: #F8F8FF;">
    <!-- Background Icons -->
...
<style scoped>
.animated-gradient {
  /* background: linear-gradient(120deg, #e0f2fe, #ede9fe, #e0e7ff); */
...
/* Icon styling for subtle effect */
.bg-icon {
  opacity: 0.15;
